        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                with playwright_sync.sync_playwright() as p:
                    ...
                    self.assertIn("maintenance", page.locator("#maintenance").inner_text().lower())
                    ...
                    self.assertIn("Dismiss this maintenance suggestion", dialog_messages[0])
                    ...
                    page.wait_for_function("document.querySelector('#maintenance').innerText.includes('chroma')")
                    self.assertIn("chroma", page.locator("#maintenance").inner_text())
                    ...
                    page.wait_for_function("document.querySelector('#maintenance').innerText.includes('local_hash_embedding')")
                    self.assertIn("local_hash_embedding", page.locator("#maintenance").inner_text())
                    browser.close()
            finally:
                server.shutdown()
